"""Device identity primitives: secret hashing, pairing codes, device JWT issue/verify.

The device JWT is backend-owned (HS256 over ``DEVICE_JWT_SECRET``). Clerk is
not in the lamp's trust chain. See ``update/changes/IMPLEMENTATION_AUTH_PAIRING.md``.
"""
...
class DeviceJwtError(ValueError):
    """JWT signature, structure, or claim verification failure."""
